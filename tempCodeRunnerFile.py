...
def tic_tac_toe_settings():
    ...
    difficulty_buttons = [
        OptionButton(320, 330, 130, 55, "Easy", "difficulty"),
        OptionButton(485, 330, 130, 55, "Medium", "difficulty"),
        OptionButton(650, 330, 130, 55, "Hard", "difficulty"),
    ]

    start_button = Button(WIDTH // 2 - 150, 500, 300, 60, "Start")
    back_button = Button(40, 40, 140, 55, "Back")
    ...
    while True:
        ...
        draw_text("TIC TAC TOE", FONT_TITLE, ACCENT, WIDTH // 2, 120)
        draw_text("Game Settings", FONT_SUBTITLE, MUTED, WIDTH // 2, 190)

        draw_text("AI Difficulty", FONT_BUTTON, TEXT, WIDTH // 2, 290)
